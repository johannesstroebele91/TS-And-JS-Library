...
const userDetails = {
    name: 'My name',
    getName: function() {
        return this.name; // userDetails Object: refers to the parent object
    }
};

console.log('This class function displays the name of the parent object using this: ' + userDetails.getName());
